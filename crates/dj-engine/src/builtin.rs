...
impl BuiltinKind {
    pub fn from_ext_id(ext_id: &str) -> Option<Self> {
        match ext_id {
            ...
            crate::clock::CLOCK_ID => Some(BuiltinKind::Clock),
            crate::grid_track::GRID_TRACK_ID => Some(BuiltinKind::GridTrack),
    ...
    pub fn ext_id(self) -> &'static str {
        match self {
            ...
            BuiltinKind::Clock => crate::clock::CLOCK_ID,
            BuiltinKind::GridTrack => crate::grid_track::GRID_TRACK_ID,
    ...
    pub fn manifest(self) -> Manifest {
        match self {
            ...
            BuiltinKind::Clock => crate::clock::clock_manifest(),
            BuiltinKind::GridTrack => crate::grid_track::grid_track_manifest(),
